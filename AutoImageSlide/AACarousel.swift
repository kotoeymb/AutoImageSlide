...
//        pageControl.pageIndicatorTintColor = UIColor.gray
    ...
    fileprivate func initWithData(_ paths:[String]) {
    ...
    public func setCarouselLayout(displayStyle:Int, pageIndicatorPositon:Int, pageIndicatorColor:UIColor?, layerColor:UIColor?) {
    ...
    public func setCarouselOpaque(layer:Bool, pageIndicator:Bool) {
    
        layerView.isHidden = true
        describedLabel.isHidden = true
        pageControl.isHidden = true
    }
    
   
    //MARK:- set data method
    public func setCarouselData(paths:[String],isAutoScroll:Bool,timer:Double?,defaultImage:String?) {
